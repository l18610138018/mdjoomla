...
<form action="<?php echo JRoute::_('index.php?option=com_emerald&view=emcoupons');?>" method="post" name="adminForm" id="adminForm" class="uk-form">
<?php echo $this->menu->render(null); ?>
	<div class="page-header">
		...
		<h1>
			<img src="<?php echo JUri::root(TRUE); ?>/components/com_emerald/images/cpanel/coupons.png" />
			<?php echo JText::_('COM_EMERALD_COUPONS'); ?>
		</h1>
	</div>
	<hr />    
	<div id="j-main-container">
		...
		<table class="uk-table uk-table-striped" id="groupsList">
			...
			foreach($this->items as $i => $item):
				...
				$canChange  = $user->authorise('core.edit.state', 'com_emerald.coupon.'.$item->id) && $canCheckin;
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td nowrap="nowrap">
						 <div class="uk-float-left">
							...
							<a href="<?php echo JRoute::_('index.php?option=com_emerald&task=emcoupon.edit&id='.(int) $item->id);?>">
								<?php echo $this->escape($item->value); ?>
							</a>
						</div>
					</td>
					<td class="nowrap center">
						<?php echo $item->discount ?> <img src="<?php echo JUri::root(true);?>/components/com_emerald/images/<?php echo $icon; ?>.png" align="absmiddle" alt="">
					</td>
					<td class="nowrap">
					...
					<td class="nowrap center">
						<?php echo EmeraldHelper::getFormattedDate($item->ctime); ?>
					</td>
					<td class="nowrap center">
						<?php if($item->extime > 0):?>
							...
							<?php if($item->expire == 1):?>
								<span style="color:red;">
									<?php echo EmeraldHelper::getFormattedDate($item->extime); ?>
								</span>
							<?php else:?>
									<?php echo EmeraldHelper::getFormattedDate($item->extime); ?>
							<?php endif;?>
