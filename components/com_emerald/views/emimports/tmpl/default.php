...
<div class="page-header">
	<h1>
		<img src="<?php echo JUri::root(TRUE); ?>/components/com_emerald/images/cpanel/import.png">
		<?php echo JText::_('COM_EMERALD_IMPORTS'); ?>
	</h1>
</div>
...
<?php foreach ($this->items as $item): ?>
	<li>
		<a href="<?php echo $this->canImport ? JRoute::_('index.php?option=com_emerald&view=emimport&name='.$item->name) : 'javascript:void(0);';?>"
