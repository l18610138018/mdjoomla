			...
			<tbody>
				<tr>
					...
					<td class="align-right">
						...
						echo EmeraldApi::getPrice($this->coupon ? $this->coupon->discount + $price : $price , $this->plan->params);
						?>
						</big>
					</td>
				</tr>
		...
		<table class=" table table-bordered pull-right" style="width: 25%;">
			<tbody>
				<tr>
					...
					<td class="align-right">- <?php echo EmeraldApi::getPrice($this->coupon ? $this->coupon->discount : 0, $this->plan->params)?></td>
				</tr>
				<tr class="success">
					<td class="align-right bold"><?php echo JText::_('E_SUBTOTAL')?>:</td>
					<td class="align-right bold"><?php echo EmeraldApi::getPrice($price, $this->plan->params)?></td>
				</tr>
				...
				<tr>
					...
					<td class="align-right">
						...
						<?php echo EmeraldApi::getPrice($tax, $this->plan->params)?>
					</td>
				</tr>
				<?php endif;?>
				<?php $price += $tax; ?>
				<tr>
					...
					<td class="align-right bold"><big><?php echo EmeraldApi::getPrice($price, $this->plan->params)?></big></td>
				</tr>
			</tbody>
		</table>
