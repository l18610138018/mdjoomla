...
<div class="pull-right">
	<?php //if(!$this->isCheckedOut()):?>
		<?php //if(in_array($this->tmpl_params->get('tmpl_core.form_show_apply_button'), $this->user->getAuthorisedViewLevels())):?>
			<button type="button" class="btn-submit btn btn-primary" onclick="Emerald.submitbutton('<?php echo $controller;?>.apply');">
			<?php echo JText::_('EAPPLY'); ?>
			</button>
		<?php //endif; ?>

		<div class="btn-group">
			<button type="button" class="btn btn-success" onclick="Emerald.submitbutton('<?php echo $controller;?>.save');">
	...
	<?php //if(in_array($this->tmpl_params->get('tmpl_core.form_show_close_button'), $this->user->getAuthorisedViewLevels())):?>
		<button type="button" class="btn-submit btn btn-danger" onclick="Emerald.submitbutton('<?php echo $controller;?>.cancel');">
