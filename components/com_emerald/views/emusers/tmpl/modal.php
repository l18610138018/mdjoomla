...
?>
<br />
<form action="<?php echo JRoute::_('index.php?option=com_emerald&view=emusers&layout=modal&tmpl=component&groups='.JRequest::getVar('groups', '', 'default', 'BASE64').'&excluded='.JRequest::getVar('excluded', '', 'default', 'BASE64'));?>" method="post" name="adminForm" id="adminForm">
	<div class="controls">
		<div class="input-append">
			...
			<button class="btn" type="submit" rel="tooltip" data-original-title="<?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?>">
				<img src="<?php echo JUri::root(true);?>/components/com_emerald/images/magnifier.png" align="absmiddle">
			</button>
			...
			<button class="btn<?php echo ($this->state->get('filter.search') ? ' btn-warning' : NULL); ?>" type="button"
				...
				<img src="<?php echo JUri::root(true);?>/components/com_emerald/images/eraser.png" align="absmiddle">
			</button>
			<?php endif; ?>
			<button class="btn<?php if($this->state->get('filter.group_id')) echo ' btn-warning'; ?>" type="button" data-toggle="collapse" data-target="#filters-block" >
				<img src="<?php echo JUri::root(true);?>/components/com_emerald/images/funnel.png" align="absmiddle">
			</button>
		</div>
	</div>
