...
class EmeraldImportAec extends EmeraldImport
{
	public  $result            = array();
	private $coupons           = [];
	private $plans             = [];
	...
	{
		$ctable = JTable::getInstance('EmCouponhistory', 'EmeraldTable');
	...
	{
		$ctable = JTable::getInstance('EmCoupon', 'EmeraldTable');
	...
	private function getGroupId()
	{
		...
		$db->setQuery("SELECT id FROM #__emerald_plans_groups LIMIT 1");
		$id = $db->loadResult();
