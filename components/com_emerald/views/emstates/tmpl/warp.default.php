...
<form action="<?php echo JRoute::_('index.php?option=com_emerald&view=emstates');?>" method="post" name="adminForm" id="adminForm" class="uk-form">
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td nowrap="nowrap">
						 <div class="uk-float-left">
							<a href="<?php echo JRoute::_('index.php?option=com_emerald&task=emstate.edit&id='.(int) $item->id);?>">
								<?php echo $item->label; ?>
							</a>
						</div>
					</td>
