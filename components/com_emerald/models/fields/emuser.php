...
class JFormFieldEmuser extends JFormField
{
	...
	protected function getInput()
	{
		...
		$link = 'index.php?option=com_emerald&amp;view=emusers&amp;layout=modal&amp;tmpl=component&amp;field='.$this->id.(isset($groups) ? ('&amp;groups='.base64_encode(json_encode($groups))) : '').(isset($excluded) ? ('&amp;excluded='.base64_encode(json_encode($excluded))) : '');
