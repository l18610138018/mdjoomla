...
<div class="input-append pull-right">
	<a class="btn" href="<?php echo EmeraldApi::getLink('emlist'); ?>">
				...
				<tr>
					<td>
						...
						<?php if($item->activated == 0): ?>
							...
							<a href="<?php echo JRoute::_('index.php?option=com_emerald&view=empayment&sid=' . $item->id) ?>" class="btn-small btn-primary ">
