...
<div class="page-header">
	<?php if(count(EmeraldHelper::getUserPlans())): ?>
		<div class="input-append pull-right">
			<a class="btn" href="<?php echo EmeraldApi::getLink('emhistory'); ?>">
	...
	<table class="pull-right table-condensed table table-bordered" style="width: 40%">
		...
		<?php elseif($this->plan->discount): $total -= $this->plan->discount; ?>
			<tr>
				...
				<td>-<?php echo EmeraldApi::getPrice($this->plan->discount, $this->plan->params); ?></td>
			</tr>
		<?php endif; ?>
		<tr>
			<td><big><?php echo JText::_('EMR_INVOICETOTAL'); ?></big></td>
			<td><strong><big><?php echo EmeraldApi::getPrice($total, $this->plan->params); ?></big></strong></td>
		</tr>
	</table>
