...
<div class="uk-float-left">
	<img src="<?php echo JUri::root(true); ?>/components/com_emerald/images/arrow-turn-270-left.png" alt="Select and" class="arrow" />
...
JText::_('SELECTFIRST', true) ?>');}else{Emerald.submitbutton('<?php echo
$single; ?>.edit');}">
...
JText::_('E_SURE_DELETE'); ?>'))Emerald.submitbutton('<?php echo
$controller; ?>.delete');}">
		<i class="uk-icon-remove"></i>&nbsp;&nbsp;<?php echo JText::_('EDELETE'); ?>
	</button>
</div>
<div class="uk-float-right">
	<button type="button" class="uk-button-submit uk-button uk-button-success" onclick="Emerald.submitbutton('<?php echo
$single; ?>.add');">
