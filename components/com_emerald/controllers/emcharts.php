...
class EmeraldControllerEmCharts extends MControllerForm
{
	public function sales()
	{
		...
		if(empty($sorted))
		{
			EmeraldAjaxHelper::error(JText::_('EMR_CHART_NODATA'));
		}
