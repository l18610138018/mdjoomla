...
class EmeraldActionGroup extends EmeraldAction
{
	...
	public function onDisactive($subscription)
	{
		...
		$user_subscrs = EmeraldHelper::getUserActiveSubscriptions(NULL, $subscription->id);
		$plan_ids     = array();
		...
		$actions       = EmeraldActionsHelper::getActions(array_values($plan_ids), 'group');
		$setted_groups = array();
