...
$canOrder = $user->authorise('core.edit.state', 'com_emerald.groups');
$saveOrder = $listOrder == 'g.ordering';

if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_emerald&task=emgroups.ordersave&tmpl=component';
...
<form class="uk-form" action="<?php echo JRoute::_('index.php?option=com_emerald&view=emgroups');?>" method="post" name="adminForm" id="adminForm" class="uk-form">
	<div class="page-header">
		...
		<h1>
			<img src="<?php echo JUri::root(TRUE); ?>/components/com_emerald/images/cpanel/groups.png" />
			<?php echo JText::_('COM_EMERALD_GROUPS'); ?>
		</h1>
	</div>
<hr />
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td nowrap="nowrap">
						 <div class="uk-float-left">
							...
							<a href="<?php echo JRoute::_('index.php?option=com_emerald&task=emgroup.edit&id='.(int) $item->id);?>">
