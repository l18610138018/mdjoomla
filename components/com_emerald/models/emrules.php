...
class EmeraldModelsEmRules extends JModelBase
{
	public function getAdapters()
	{
		...
		foreach($acts AS $a)
		{
			if($a == 'default')
			{
				$def = JHtml::_('select.option', $a, EmeraldRulesHelper::get_rule_name($a));
				continue;
			}
			$options[] = JHtml::_('select.option', $a, EmeraldRulesHelper::get_rule_name($a));
		}
	...
	/*public function getComponents()
	{
		...
		$skip = array(
			...
			'com_gantry', 'com_installer', 'com_media', 'com_language', 'com_menu', 'com_jaextmanager', 'com_emerald', 'com_jslang',
