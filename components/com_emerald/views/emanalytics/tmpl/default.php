...
<div class="page-header">
	<h1>
        <img src="<?php echo JUri::root(TRUE); ?>/components/com_emerald/images/cpanel/analytics.png" />
...
(function($) {
	...
	$.getJSON('<?php echo JRoute::_('index.php?option=com_emerald&task=emcharts.stack'); ?>', function(data) {
...
$.getJSON('<?php echo JRoute::_('index.php?option=com_emerald&task=emcharts.sales'); ?>', function(data) {
...
$.getJSON('<?php echo JRoute::_('index.php?option=com_emerald&task=emcharts.counts'); ?>', function(data) {
...
options_pie.series[0].name = '<?php echo JText::_('COM_EMERALD_GROUPS'); ?>';
options_pie.series[1].name = '<?php echo JText::_('E_PLAN'); ?>';

$.getJSON('<?php echo JRoute::_('index.php?option=com_emerald&task=emcharts.piemain'); ?>', function(data) {
	if(!data.success || !data.result) {
