				...
				<td>
					<table class="table table-bordered table-condensed">
						...
						<tr>
							...
							<td><?php echo EmeraldHelper::getFormattedDate($this->subscr->ctime) ?></td>
						</tr>
						<tr>
		...
		<div class="row-fluid">
			...
			<table class="table table-bordered table-items table-condensed">
				...
				<tr>
					...
					<td class="align-right">
						<big>
							...
							echo EmeraldApi::getPrice(($this->discount ? $this->discount + $price : $price) - $this->items_total, $this->plan->params, $this->subscr->params);
							?>
						</big>
					</td>
				</tr>
				<?php foreach($this->items AS $i => $item): ?>
					<tr>
						...
						<td class="align-right">
							<big>
								<?php echo EmeraldApi::getPrice($item['price'], $this->plan->params); ?>
							</big>
						</td>
					</tr>
				<?php endforeach; ?>
			...
			<table class=" table table-bordered pull-right" style="width: 35%;">
				...
				<tr>
					...
					<td class="align-right">- <?php echo EmeraldApi::getPrice($this->discount, $this->plan->params, $this->subscr->params) ?></td>
				</tr>
				<tr class="success">
					<td class="align-right bold"><?php echo JText::_('E_SUBTOTAL') ?>:</td>
					<td class="align-right bold"><?php echo EmeraldApi::getPrice($price, $this->plan->params, $this->subscr->params) ?></td>
				</tr>
				<?php $tax = 0;
				if(!empty($this->tax['percent'])): ?>
					<tr>
						...
						<td class="align-right">
							...
							<?php echo EmeraldApi::getPrice($tax, $this->plan->params, $this->subscr->params) ?>
						</td>
					</tr>
				<?php endif; ?>
				<?php $price += $tax; ?>
				<tr>
					...
					<td class="align-right bold"><big><?php echo EmeraldApi::getPrice($price, $this->plan->params, $this->subscr->params)?></big></td>
				</tr>
				</tbody>
			</table>
