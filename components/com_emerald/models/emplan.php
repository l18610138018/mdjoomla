...
class EmeraldModelEmPlan extends MModelAdmin
{

	public function getTable($type = 'EmPlan', $prefix = 'EmeraldTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		$form = $this->loadForm('com_emerald.plan', 'plan', array(
			'control' => 'jform',
			'load_data' => $loadData
		));
		if(empty($form))
	...
	{
		$data = JFactory::getApplication()->getUserState('com_emerald.edit.emplan.data', array());
