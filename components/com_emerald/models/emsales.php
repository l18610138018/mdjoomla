...
class EmeraldModelEmSales extends MModelList
{
	...
	public function getListQuery()
	{
		...
		if($search)
		{
			...
			{
				case 'cpn:':
					$query->leftJoin('#__emerald_coupons_history as ch ON ch.subscription_id = s.id');
	...
	public function getSubscriptionCouponInfo($sid)
	{
		...
		FROM #__emerald_coupons_history ch
		LEFT JOIN #__emerald_coupons cc ON cc.id = ch.coupon_id
	...
	public function getGroups($empty_value = FALSE)
	{
		...
		$query->from('#__emerald_plans_groups');
		$query->order('text');
		$db->setQuery($query);
