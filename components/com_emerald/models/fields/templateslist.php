...
class JFormFieldTemplateslist extends JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		$tmpls_path = JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_emerald' . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . 'emlist' . DIRECTORY_SEPARATOR . 'tmpl';
