...
class EmeraldActionAcymail extends EmeraldAction
{
	...
	public function onDisactive($subscription)
	{
		...
		$user_subscrs = EmeraldHelper::getUserActiveSubscriptions();
		$plan_ids     = array();
		...
		$actions = EmeraldActionsHelper::getActions(array_values($plan_ids), 'acymail');
		$allowed = array();
